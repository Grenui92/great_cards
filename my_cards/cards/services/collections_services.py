...
class CollectionServices:
    ...
    def get_collection_by_id(collection_id):
        """
        The get_collection_by_id function takes in a collection_id and returns
        the CardsCollections object with that id.
    ...
    def get_collections_by_owner(owner_id):
        """
        The get_collections_by_owner function returns a list of all collections
        owned by the user with the given owner_id.
