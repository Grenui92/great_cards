...
urlpatterns = [
    ...
    path('cards/change_position/',
         ChangeCardsOrderApi.as_view(),
         name='change_order'),
    path('cards/create_card/',
         CreateCardApi.as_view(),
         name='create_card'),
    path('cards/get_card_information/',
         GetCardInformation.as_view(),
         name='get_card_information'),
    path('cards/create_collection/',
         CreateCollecitonApi.as_view(),
         name='create_collection'),
    path('chat/translate_sentences/',
         TranslateSentencesApi.as_view(),
